...
- upload_file stores a real file (image, PDF, document, up to 4 MB, base64-encoded) as a findable memory — write a real summary, since recall() searches that, not the filename.
